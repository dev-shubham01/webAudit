...
import NetworkScreen from "../../features/network/NetworkScreen.jsx";
    ...
    return (
      <div className="flex h-[60vh] flex-col items-center justify-center text-center text-[#94A3B8]">
        ...
        <p className="mt-2 max-w-md text-sm">
          Run a crawl from the Dashboard first to see the internal linking map here.
        </p>
      </div>
    );
  }

  return <NetworkScreen report={data} />;
}
