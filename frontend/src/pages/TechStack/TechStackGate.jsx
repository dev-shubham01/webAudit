...
import TechStackScreen from "../../features/techstack/TechStackScreen.jsx";

export default function TechStackGate() {
    ...
    return (
      <div className="flex h-[60vh] flex-col items-center justify-center text-center text-[#94A3B8]">
        ...
        <p className="mt-2 max-w-md text-sm">
          Run a crawl from the Dashboard first to see detected technologies here.
        </p>
      </div>
    );
  }

  return <TechStackScreen report={data} />;
}
