...
import GalleryScreen from "../../features/gallery/GalleryScreen.jsx";
  ...
  if (!data) {
    ...
    return (
      <div className="flex h-[60vh] flex-col items-center justify-center text-center text-[#94A3B8]">
        ...
        <p className="mt-2 max-w-md text-sm">Run a crawl from the Dashboard first to see the image gallery here.</p>
      </div>
    );
  }

  return <GalleryScreen report={data} />;
}
