...
import RedirectsScreen from "../../features/redirects/RedirectsScreen.jsx";
    ...
    return (
      <div className="flex h-[60vh] flex-col items-center justify-center text-center text-[#94A3B8]">
        ...
        <p className="mt-2 max-w-md text-sm">
          Run a crawl from the Dashboard first to see redirects here.
        </p>
      </div>
    );
  }

  return <RedirectsScreen report={data} />;
}
